        ...
        <form className="space-y-6" onSubmit={formik.handleSubmit}>
          ...
          {step === 2 && (
            <>
              ...
              >
                <ArrowLeft />
                <h5 className="text-xl ml-1 font-medium text-danger">
                  Kembali
                </h5>
              </div>
              <div>
              ...
              <button
                ...
                type="submit"
                className="w-full uppercase text-white bg-dangerious hover:bg-red-800  font-medium rounded-md text-sm px-5 py-2.5 text-center shadow-lg disabled:opacity-50 "
              >
                Selanjutnya
              </button>
              <hr />
